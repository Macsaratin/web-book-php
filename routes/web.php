...
Route::get('/dang-ky', [AuthController::class, 'registration'])->name('auth.registration');
Route::post('/dang-ky', [AuthController::class, 'doRegistration'])->name('auth.doRegistration');
...
Route::get('/tai-khoan', [AuthController::class, 'account'])->name('shop.user.account');
